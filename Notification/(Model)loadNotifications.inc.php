<?php
    ...
    $sql = "SELECT * FROM `notifications`n JOIN `account`a on n.notif_sender=a.account_Id WHERE json_extract(`notif_params`, '$.receiver') = '".$account_Id."' AND `notif_status`=0 ORDER BY created_at DESC LIMIT ".$start.",".$end."";
