<?php 
	...
	$sql="SELECT r.`reply_id`,r.`reply_data`, r.`reply_likes`, r.`reply_date`,p.`post_question`,p.`post_tag`,p.`post_likes`,p.`post_context`,r.`post_id`,p.`post_date`,a.`first_name`,a.`last_name` 
